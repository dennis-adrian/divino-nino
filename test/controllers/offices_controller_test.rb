...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference("Office.count") do
      post offices_url, params: { office: { room: @office.room, specialty_id: @office.specialty_id } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { room: @office.room, specialty_id: @office.specialty_id } }
